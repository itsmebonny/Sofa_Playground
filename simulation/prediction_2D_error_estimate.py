...
class AnimationStepController(Sofa.Core.Controller):
    def __init__(self, node, *args, **kwargs):
        ...
        self.network = Trainer('npy/2024-05-17_12:02:10_estimation/train', 32, 0.001, 1000)
        self.network.load_model('models/model_2024-05-17_12:22:37.pth')
    ...
    def createGraph(self, rootNode):
        ...
        rootNode.addObject('VisualStyle', name="visualStyle", displayFlags="showBehaviorModels")
        ...
        self.nnModel.addObject('RegularGridTopology', name='grid', min=p_grid_LR.min, max=p_grid_LR.max, nx=p_grid_LR.res[0], ny=p_grid_LR.res[1], nz=p_grid_LR.res[2])
        ...
        self.nnModel.addObject('BoxROI', name='ROI2', box="9.9 -1.1 -0.1 10.1 1.1 0.1")
