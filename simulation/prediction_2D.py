...
class AnimationStepController(Sofa.Core.Controller):
    def __init__(self, node, *args, **kwargs):
        ...
        self.network = Trainer('npy/2024-04-23_15:43:22/train', 32, 0.001, 1000)
        self.network.load_model('models/model_2024-04-23_16:11:10.pth')
    ...
    def onAnimateEndEvent(self, event):
        ...
        # add the z component
        U = np.reshape(U, (self.high_res_shape[0], self.high_res_shape[1]))
        ...
        self.MO_NN.position.value = self.MO_NN.rest_position.value + U
