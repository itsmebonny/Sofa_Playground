...
if __name__ == '__main__':
    ...
    if mesh_type == "rectangle":
        ...
        for i in range(n_simulations):
            ...
            create_plate_with_hole(length, width, thickness, hole_radius, hole_x, hole_y, 0.4)
            gmsh.finalize()
            gmsh.initialize(sys.argv)
            gmsh.model.add("plate")
            create_plate_with_hole(length, width, thickness, hole_radius, hole_x, hole_y, 1.8)
            gmsh.finalize()
