...
class AnimationStepController(Sofa.Core.Controller):
    ...
    def onAnimateBeginEvent(self, event):
        ...
        self.cff_box_LR_FC = self.LowResSolution_FC.addObject('BoxROI', name='ForceBox', drawBoxes=True, drawSize=1, box=[x_min, y_min, -0.1, x_max, y_max, 0.1])
    ...
    def onAnimateEndEvent(self, event):
        ...
        boundary_conditions = np.zeros((8))
        boundary_conditions[:-4] = [x_min, x_max, y_min, y_max]
