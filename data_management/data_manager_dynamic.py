...
class DataManager:
    ...
    def join_data(self, train_size=0.8, normalize=False):
...
if __name__ == "__main__":
    # Example of usage
    dm = DataManager('npy/2024-07-26_15:55:18_dynamic_simulation')
    dm.join_data()
    dm2 = DataManager('npy/2024-07-26_15:55:18_dynamic_simulation')
